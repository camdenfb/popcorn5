...
<div class="container2">
 <h3>New in Theater</h3>
  <ul class="nav nav-tabs">
    <li class="active"><a data-toggle="tab" href="#menu1">This Month</a></li>
    <li><a data-toggle="tab" href="#menu2">Next Month</a></li>
  </ul>
...
<table class="table">
  ...
  <c:otherwise>
    <img src="${context}/images/masks.png" style="height:30px">
         ...
         <td>
      <fmt:formatDate type="date" value="${prod.prodRelease}"/>
      </td>
...
<table class="table">
	...
	<fmt:formatDate var="prodyear" value="${prod.prodRelease}" pattern="yyyy" />
	<fmt:formatDate var="prodmonth" value="${prod.prodRelease}" pattern="MM" />
	<c:if test="${(prod.prodType == 'theater')&&(prodyear == yearnow)&&(prodmonth == monthnow+1)}">
      <tr>
         <td><img src="${context}/images/${prod.prodPic}" style="width:80px"></td>
