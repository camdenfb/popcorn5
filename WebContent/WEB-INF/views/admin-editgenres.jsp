...
<hr>	
		 ...
		 <c:set var="match" value="false"/>
		  ...
		  <c:forEach items="${prodgenres}" var="prodgenre">
		  <c:if test="${genre.genreId == prodgenre.genre.genreId}">
		...
		<c:when test="${match==true}">
    	 ...
    	 <tr>
			 <td><input type="checkbox" name="genres" value="${genre.genreId}" checked/></td>
			<td>${genre.genre}</td>
			</tr>
