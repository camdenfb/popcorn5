...
<div class="container2">
 <h3>Top Rated Theater</h3>
<h5>By Genre</h5>
  <ul class="nav nav-tabs">
    <li class="active"><a data-toggle="tab" href="#home">Children's Theater</a></li>
    <li><a data-toggle="tab" href="#menu1">Comedy</a></li>
    <li><a data-toggle="tab" href="#menu2">Dance</a></li>
    <li><a data-toggle="tab" href="#menu3">Drama</a></li>
    <li><a data-toggle="tab" href="#menu4">Musical</a></li>
    <li><a data-toggle="tab" href="#menu5">Straight Play</a></li>
  </ul>
...
<table class="table">
	<c:forEach items="${childrens}" var="prod">
	<c:if test="${prod.prodg.prodType == 'theater'}">
      <tr>
...
<table class="table">
 ...
 <!-- </div> -->
    ...
    <div class="panel-body">
<table class="table">
	<c:forEach items="${dance}" var="prod">
	<c:if test="${prod.prodg.prodType == 'theater'}">
      <tr>
         <td><img src="${context}/images/${prod.prodg.prodPic}" style="width:80px"></td>
...
<table class="table">
 ...
 <!-- </div> -->
    ...
    <div class="panel-body">
<table class="table">
	<c:forEach items="${musical}" var="prod">
	<c:if test="${prod.prodg.prodType == 'theater'}">
      <tr>
         <td><img src="${context}/images/${prod.prodg.prodPic}" style="width:80px"></td>
 ...
 <!-- </div> -->
    ...
    <div class="panel-body">
<table class="table">
	<c:forEach items="${straight}" var="prod">
	<c:if test="${prod.prodg.prodType == 'theater'}">
      <tr>
         <td><img src="${context}/images/${prod.prodg.prodPic}" style="width:80px"></td>
